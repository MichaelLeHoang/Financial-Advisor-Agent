  ...
  return (
    <div className="min-h-full bg-[var(--theme-bg)] px-4 py-6 text-[var(--text-primary)] lg:px-7 xl:px-10">
      <div className="mx-auto max-w-[1680px]">
        ...
        <div className="mt-7 flex gap-2 overflow-x-auto border-b border-[var(--theme-border)] pb-4" role="group" aria-label="Activity filters">
        ...
        <section aria-label="Investment activity list" className="mt-2">
          {visible.map((item) => <div key={item.id} className="grid gap-3 border-b border-[var(--theme-border)] py-5 sm:grid-cols-[44px_120px_90px_minmax(0,1fr)_auto] sm:items-center">
