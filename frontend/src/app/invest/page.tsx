...
import { DataReveal, DelayedSkeleton, RefreshingIndicator } from "@/components/ui/DataLoading";
        ...
        <div className="mt-6 grid min-w-0 gap-4 xl:grid-cols-[minmax(0,2.35fr)_minmax(320px,0.65fr)]">
          <div className="min-w-0">
            <section id="performance" aria-labelledby="performance-heading" className="min-w-0 scroll-mt-16">
              ...
              {quotesLoading && series.length <= 1 ? <DelayedSkeleton className="h-full w-full rounded-sm" label="Loading estimated history" /> : series.length > 1 ? (
