    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className={cn(
            "fixed bottom-[max(0.75rem,env(safe-area-inset-bottom))] left-[max(0.75rem,env(safe-area-inset-left))] right-[max(0.75rem,env(safe-area-inset-right))] z-[230] flex h-[min(680px,calc(100dvh-1.5rem))] flex-col overflow-hidden rounded-3xl border border-[var(--theme-border-strong)] bg-[var(--surface-dialog)] text-[var(--text-primary)] shadow-[var(--shadow-dialog)] md:inset-x-auto md:bottom-4 md:w-[min(420px,calc(100vw-6rem))]",
