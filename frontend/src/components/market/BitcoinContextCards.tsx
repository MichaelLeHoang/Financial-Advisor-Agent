    ...
    <>
      <Card className="gap-0 py-0">
        ...
        <CardContent className="grid gap-px bg-[var(--theme-border)] p-0 sm:grid-cols-2 xl:grid-cols-6">
          ...
          <Metric label="24h change" value={overview?.change_24h == null ? "—" : `${overview.change_24h >= 0 ? "+" : ""}${overview.change_24h.toFixed(2)}%`} description="Percentage price change over the latest rolling 24-hour period." tone={overview?.change_24h == null ? "amber" : overview.change_24h >= 0 ? "emerald" : "rose"} icon={Activity} />
