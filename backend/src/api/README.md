...
- `equity_research.py`: Quanfora 2.1 run, event, share, and report routes.
...
## Latest Change
- Updated API-facing Quanfora naming for consensus and equity research route documentation.
